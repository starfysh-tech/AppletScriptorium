...
```
- For Cloudflare-guarded links, install Playwright (`uv pip install --system --python python3 playwright` then `playwright install`) so the automation can render the challenge pages headlessly.
